...
<body>
	...
	<div class="container bg-light h-100 text-center">




		<div class="row">
			<h1 class="display-1 p-3">What is Mars Imager?</h1>
		</div>
		...
		<div class="row parralaxContainer">
			<div class="col">
		...
		<div class="row parallaxDivider"></div>
		...
		<div class="row parralaxContainer">
			<div class="col">
			  ...
			  <div class="parrallaxText p-1">
			    <h1 id="Cur" class="fs-1 lead">See Mars through the Curiosity rover</h1>
		...
		<div class="row parralaxContainer">
			<div class="col">
			  <div class="parallax parallaxImg3">
			  
			  </div>
			  <div class="parrallaxText p-1">
			    <h1 id="SpOp" class="fs-1 lead">Spirit and twin rover Opportunity</h1>
		...
		<footer class='row text-center' style="background-color: rgba(61, 61, 61, 1);">
